...
//        context.registerBean("myBean666", MyBean.class);



        context.registerBean("myConfig1", MyConfig1.class);
////        context.registerBean("myConfig2", MyConfig2.class);  // 用内置依赖注入和初始化取代扩展依赖注入和初始化
        ...
        context.refresh(); // 1. 执行beanFactory 后处理器,用来补充bean定义  2. 添加 bean 后处理器, 3. 初始化单例
        context.close();
