...
//       // reader.loadBeanDefinitions(new FileSystemResource("E:\\software\\java\\spring\\spring核心\\代码\\show\\src\\main\\resources\\a02.xml"));
//        for (String name : beanFactory.getBeanDefinitionNames()) {
//            System.out.println(name);
//        }
    ...
    private static void testFileSystemXmlApplicationContext() {
        FileSystemXmlApplicationContext context =
                new FileSystemXmlApplicationContext(
                        "E:\\software\\java\\spring\\spring核心\\代码\\show\\src\\main\\resources\\a02.xml");
        for (String name : context.getBeanDefinitionNames()) {
            System.out.println(name);
        }
    ...
    static class WebConfig {
        ...
        public ServletWebServerFactory servletWebServerFactory(){
            return new TomcatServletWebServerFactory();  // 产生tomcat
        }
        @Bean
        ...
        public Controller controller1() {
            return (request, response) -> {
                response.getWriter().print("hello666");
                return null;
            };
        }
    }
